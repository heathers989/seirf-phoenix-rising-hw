...
mv yavin_4/{millenium_falcon,x_wing} ../galaxy_far_far_away/
# In `death_star`, create directories for `tie_fighter_1`, `tie_fighter_2` and `tie_fighter_3`
mkdir death_star/{tie_fighter_1,tie_fighter_2,tie_fighter_3}
...
# Move all of the `tie_fighters` out of the `death_star` and into `galaxy_far_far_away`
 mv death_star/{tie_fighter_1,tie_fighter_2,tie_fighter_3} ../galaxy_far_far_away/
...
# Celebrate!
touch yavin_4/award_medals.txt