# other options for creating cards with suits
...
while play == true do
    ...
    check_bal = $stdin.gets.chomp
    if check_bal == 'b'
        puts "Your current bankroll balance is #{human_player.bankroll}"
    end

    puts "Press the return key to shuffle the deck..."
    $stdin.gets
    deck.shuffle!
    puts "Deck shuffled!"
    ...
    puts "How much would you like to bet? The default/minimum bet is 10, and maximum is your bankroll balance, which is currently at #{human_player.bankroll}."
